...
WORKING_DIRECTORY = 'C:\ML\Realtime-Fall-Detection-for-RNN-master'

Label = {0: 'teste',1: 'Standing', 2: 'Walking', 3: 'Joging', 4: 'Jumping', 5: 'Up stair', 6: 'Down stair', 7: 'stand to sit',
         8: 'Siting', 9: 'Sit to stand', 10: 'Car-step in', 11: 'Car-step out', 12: 'Lying', 13: 'Forward-Lying', 14: 'Front-knees-Lying', 15: 'Back-sitting-chair', 16: 'Sideward-lying'}
    ...
    def draw_flow(self, test_data, test_label):
        ...
        for i in range(num):
            if i > int(time_step/run_step):
                ...
                #print('idx 1',test_label[i * run_step])
                #print('idx 2',predict[int(time_step - 1)][0])
