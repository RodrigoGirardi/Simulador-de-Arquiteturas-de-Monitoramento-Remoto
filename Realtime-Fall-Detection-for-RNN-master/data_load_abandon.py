"""
This DataLoad trains all csv files under the train file, but does not merge all csv files.
Obtain batchsize data from each csv for training. This does not guarantee the randomness of the data, so the training effect will be poor.
