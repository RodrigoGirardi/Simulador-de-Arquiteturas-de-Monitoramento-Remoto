...
plt.plot(xP1, dfP1['temp'],  label= 'Paciente 1')  # Gráfico de linha
plt.plot(xP2, dfP2['temp'],  label='Paciente 2')  # Gráfico de linha
plt.plot(xP3, dfP3['temp'],  label='Paciente 3')  # Gráfico de linha
plt.plot(xP4, dfP4['temp'],  label='Paciente 4')  # Gráfico de linha
plt.plot(xP5, dfP5['temp'],  label='Paciente 5')  # Gráfico de linha
plt.plot(xP6, dfP6['temp'],  label='Paciente 6')  # Gráfico de linha
plt.plot(xP7, dfP7['temp'],  label='Paciente 7')  # Gráfico de linha
plt.plot(xP8, dfP8['temp'],  label='Paciente 8')  # Gráfico de linha
plt.plot(xP9, dfP9['temp'],  label='Paciente 9')  # Gráfico de linha
plt.plot(xP10, dfP10['temp'],  label='Paciente 10')  # Gráfico de linha
...
plt.savefig('C:\\Users\\Rodrigo Girardi\\Desktop\\Pacientes para Analise\\temp\\' + str(ATIVIDADE)+'_'+ str(LETRA)+'_'+ str(INDEX) +'.png', dpi=300)
# Mostrando o gráfico
#plt.show()