...
canvas1_widget.pack()
num_points = 25
#sizeArq = os.path.getsize('C:Decoder\packOk.csv')
...
'''waveTime.put(random.randint(1, 100))#(pack(0))
#print(f"time= {waveTime.get()}")
waveAcex.put(random.randint(1, 100))#(pack(1))
#print(f"acex={waveAcex.get()}")
waveAcey.put(random.randint(1, 100))#(pack(2))
#print(f"acey = {waveAcey.get()}")
waveAcez.put(random.randint(1, 100))#(pack(3))
#print(f"acez = {waveAcez.get()}")
waveGyx.put(random.randint(1, 100))#(pack(4))
#print(f"gyx = {waveGyx.get()}")
waveGyy.put(random.randint(1, 100))#(pack(5))
#print(f"gyy = {waveGyy.get()}")
waveGyz.put(random.randint(1, 100))#(pack(6))S
#print(f"gyz = {waveGyz.get()}")
waveAzi.put(random.randint(1, 100))#(pack(7))
#print(f"azi = {waveAzi.get()}")
wavePitch.put(random.randint(1, 100))#(pack(8))
#print(f"pitch = {wavePitch.get()}")
waveRoll.put(random.randint(1, 100))#(pack(9))'''
